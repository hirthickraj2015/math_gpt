...
def _():
    ...
    return F, device, nn, os, plt, time, torch, wandb
...
def _(full_text):
    ...
    return chars, encode, itos, stoi, vocab_size
...
def _(
    ...
    return iterations, test_losses, train_losses
...
@app.cell
def _(iterations, plt, test_losses, train_losses, wandb):
    ...
    if wandb.run is not None:
        wandb.log({"training_loss_plot": wandb.Image('part1_training_loss.png')})
    return
